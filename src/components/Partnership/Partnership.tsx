...
const Partnership: React.FC = () => {
  return (
    <>
      <section className="shadow-sm shadow-gray-500 custom-container mt-[60px] lg:mt-[67px] rounded-xl flex justify-between items-center lg:items-start flex-col lg:flex-row">
        {/* Right content */}
        <div className="flex flex-col py-[23px] px-5 lg:py-8 lg:px-[30px]">
          ...
          <div className="mt-5 lg:mt-[68px]">
            <h4 className="text-[#18181D] font-black text-[50px] leading-[58px]">
              Партнерство
        ...
        {/* Right left (image) */}
        <div>
          <img loading="lazy" src={partnershipImage} alt="partnershipImage" />
        </div>
      </section>
    </>
  );
